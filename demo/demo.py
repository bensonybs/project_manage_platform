...
df = pd.read_csv("./internet_cleaned(for demo).csv")
df = df[df['year'] == 2019]
...
# wait for import app.layout = dbc.Container()
...
app.layout = html.Div([
    dash_table.DataTable(
        ...
        row_deletable=
        True,  # choose if user can delete a row (True) or not (False)
